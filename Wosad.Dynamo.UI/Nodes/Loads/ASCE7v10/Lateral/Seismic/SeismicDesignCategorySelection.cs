...
namespace Wosad.Loads.ASCE7v10.Lateral.Seismic.General
{
    ...
    [NodeCategory("Wosad.Loads.ASCE7v10.Lateral.Seismic.General")]
    ...
    public class SeismicDesignCategorySelection : UiNodeBase
    {
        ...
        public SeismicDesignCategorySelection()
        {
            ...
            OutPortData.Add(new PortData("SeismicDesignCategory", "Seismic design category (SDC)"));
            RegisterAllPorts();
        ...
        protected override void SerializeCore(XmlElement nodeElement, SaveContext context)
        {
            ...
            nodeElement.SetAttribute("SeismicDesignCategory", SeismicDesignCategory);
        }
        ...
        protected override void DeserializeCore(XmlElement nodeElement, SaveContext context)
        {
            ...
            var attrib = nodeElement.Attributes["SeismicDesignCategory"];
            if (attrib == null)
                return;

            SeismicDesignCategory = attrib.Value;
