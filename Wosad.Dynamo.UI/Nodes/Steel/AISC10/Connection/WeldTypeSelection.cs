...
namespace Wosad.Steel.AISC10.Connection
{
    ...
    [NodeCategory("Wosad.Steel.AISC10.Connection.Welded")]
    ...
    public class WeldTypeSelection : UiNodeBase
    {
        ...
        protected override void SerializeCore(XmlElement nodeElement, SaveContext context)
        {
            ...
            nodeElement.SetAttribute("WeldType", WeldType);
        }
        ...
        protected override void DeserializeCore(XmlElement nodeElement, SaveContext context)
        {
            ...
            var attrib = nodeElement.Attributes["WeldType"];
            if (attrib == null)
                return;
           
            WeldType = attrib.Value;
