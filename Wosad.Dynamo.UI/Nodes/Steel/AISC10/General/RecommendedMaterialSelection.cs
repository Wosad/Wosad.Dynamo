...
namespace Wosad.Steel.AISC10.General
{
    ...
    [NodeCategory("Wosad.Steel.AISC10.General.MaterialProperties")]
    ...
    public class RecommendedMaterialSelection : UiNodeBase
    {
        ...
        private void FetchList(string ElementTypeId, string MaterialGroupId)
        {
            AvailableMaterials = null;
                ...
                string resourceName = string.Format("WosadDynamoUI.Resources.{0}.txt", MaterialGroupId);
        ...
        private List<FastenerLimitEntry> FetchFastenerLimitList()
        {
            ...
            string resourceName = "WosadDynamoUI.Resources.AiscMaterialFastenerDiameterLimits.txt";
                var assembly = Assembly.GetExecutingAssembly();
