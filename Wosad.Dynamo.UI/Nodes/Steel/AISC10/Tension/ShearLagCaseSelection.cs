...
namespace Wosad.Steel.AISC10.Tension
{
    ...
    [NodeCategory("Wosad.Steel.AISC10.Tension")]
    ...
    public class ShearLagCaseIdSelection : UiNodeBase
    {
        ...
        {
            Uri uri = new Uri("pack://application:,,,/WosadDynamoUI;component/Views/Steel/AISC_10/Tension/ShearLagFactorIdTreeData.xml");
