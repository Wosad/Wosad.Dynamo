...
using WosadSection = Wosad.Common.Section.SectionTypes;
...
/// <summary>
    ///     HSS to transverse plate connection local yielding of plate
...
/// <returns name="IsApplicableLimitState"> Identifies whether the selected limit state is applicable </returns>
        ...
        public static Dictionary<string, object> HssToTransversePlateLocalYieldingStrengthOfPlate(CustomProfile HssSection,CustomProfile PlateSection,
          double theta, string HssTransversePlateType, double F_y, double F_yp, bool IsTensionHss, double P_uHss, double M_uHss)
        {
            ...
            else
            {
                ...
                if (HssSection.Section is ISectionPipe)
                {
                    ...
                    limitState = transversePlateChs.GetLocalYieldingStrengthOfPlate();
                ...
                else if (HssSection.Section is ISectionTube)
                {
                    ...
                    limitState = transversePlateRhs.GetLocalYieldingStrengthOfPlate();
                    phiR_n = limitState.Value;
                    IsApplicableLimitState = limitState.IsApplicable;
