...
namespace Steel.AISC.HSS
{
    ...
    public partial class Truss
    {
        ...
        public static Dictionary<string, object> ChordSidewallLocalYieldingStrength(string HssTrussConnectionMemberType, string HssTrussConnectionClassification, CustomProfile MainBranchSection, double theta_main, string AxialForceTypeMain,
