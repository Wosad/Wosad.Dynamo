...
/// 
    ...
    public partial class Flexure 
    {
        ...
        public static Dictionary<string, object> FlexuralFlangeLocalBuckling(CustomProfile Shape, double F_y, string BendingAxis="Axis", string FlexuralCompressionLocation="Top",
