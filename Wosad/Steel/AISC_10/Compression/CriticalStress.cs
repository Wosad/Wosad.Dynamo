...
/// <param name="K_z">  Effective length factor for torsional buckling </param>
        ...
        /// <returns name="F_cr"> Critical stress </returns>

        [MultiReturn(new[] { "F_cr" })]
        public static Dictionary<string, object> CriticalStress(string SteelShapeId,string SteelSection,double G,double K_x,double K_y,double K_z)
        {
            //Default values
            double F_cr = 0;
        ...
        //internal CriticalStress (string SteelShapeId,string SteelSection,double G,double K_x,double K_y,double K_z)
        //{

        //}
        //[IsVisibleInDynamoLibrary(false)]
        //public static CriticalStress  ByInputParameters(string SteelShapeId,string SteelSection,double G,double K_x,double K_y,double K_z)
        //{
        //    return new CriticalStress(SteelShapeId ,SteelSection ,G ,K_x ,K_y ,K_z );
        //}
