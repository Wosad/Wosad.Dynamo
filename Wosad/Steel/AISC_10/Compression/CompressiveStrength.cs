...
/// <param name="A_g">  Gross cross-sectional area of member /param>
        ...
        public static Dictionary<string, object> Compressive strength(double F_cr,double A_g)
        {
            //Default values
            double phiP_n = 0;
        ...
        string _CompressiveStrength ;

        internal CompressiveStrength (double F_cr,double A_g)
        {

        }
        [IsVisibleInDynamoLibrary(false)]
        public static CompressiveStrength  ByInputParameters(double F_cr,double A_g)
        {
            return new CompressiveStrength(double F_cr,double A_g);
        }
