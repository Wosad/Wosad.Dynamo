...
/// <param name="A_nv">  Net area subject to shear </param>
        ...
        public static Dictionary<string, object> ConnectedElementStrengthInShear(double A_gv,double F_y,double F_u,double A_nv)
        {
            //Default values
            double phiR_n = 0;
        ...
        //internal AffectedElements (double A_gv,double F_y,double F_u,double A_nv)
        //{

        //}
        //[IsVisibleInDynamoLibrary(false)]
        //public static AffectedElements  ByInputParameters(double A_gv,double F_y,double F_u,double A_nv)
        //{
        //    return new AffectedElements(A_gv ,F_y ,F_u ,A_nv );
        //}
