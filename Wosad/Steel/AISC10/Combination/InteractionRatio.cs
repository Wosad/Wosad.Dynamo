...
using combo = Wosad.Steel.AISC.AISC360v10.Combination;
using System;
...
/// 
    ...
    public partial class Combination 
    {
        ...
        public static Dictionary<string, object> InteractionRatio(string CombinationCaseId, double N_u = 0, double T_uTorsion = 0, double M_ux = 0, double M_uy = 0, double V_ur = 0,  double phiN_n = 0, double phiT_nTorsion = 0, double phiM_nx = 0, double phiM_ny = 0, double phiV_nr = 0)
        {
            //Default values
