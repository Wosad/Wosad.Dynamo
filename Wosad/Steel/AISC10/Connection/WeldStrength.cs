...
/// 
    ...
    public partial class Welded 
    {
        ...
        public static Dictionary<string, object> WeldStrength(double l_weld, string WeldType, string WeldLoadTypeId, double t_weld, double F_EXX=70, double A_nBase = 0, double F_y = 36, double F_u = 58, double theta = 0, bool IgnoreBaseMetalChecks = false)
        {
            //Default values
            double phiR_n = 0;
