...
using Dynamo.Nodes;
using conx = Wosad.Steel.AISC.AISC360v10.Connections;
...
/// 
    ...
    public partial class ExtendedSinglePlate 
    {
        ...
        public static Dictionary<string, object> ExtendedSinglePlateShearStrengthWithoutStabilizer(double d_pl,double t_p,double a_bolts,double F_y)
        {
            //Default values
            double phiR_n = 0;
