...
/// <summary>
///     UFM forces moment at beam gusset interface
...
/// 
    ...
    {
        /// <summary>
        ///     Connection interface forces per Uniform Force Method for brace connection.  Case when moment is present at BEAM-to-gusset interface. 
        /// </summary>
        ...
        public static Dictionary<string, object> UFMForcesMomentAtBeamGussetInterface(double d_b,double d_c,double theta,double alpha,
            double alpha_bar,double beta,double P_u,double R_beam,bool IncludeDistortionalMomentForces=false,double M_d=0,double A_ub=0)
        {
            //Default values
                double V_uc = 0;
                double H_uc = 0;
