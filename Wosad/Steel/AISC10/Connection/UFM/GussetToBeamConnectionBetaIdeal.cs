...
namespace Steel.AISC10.Connection
{
    ...
    {
        /// <summary>
        ///     Distance from the face of the beam flange to the ideal centroid of the gusset-to-column connection for brace connection.
        /// </summary>
        ...
        public static Dictionary<string, object> GussetToBeamConnectionBetaIdeal(double d_b,double d_c,double theta,double alpha)
        {
            //Default values
            double beta = 0;
