...
/// 
    ...
    {
        /// <summary>
        ///     Connection interface forces per Uniform Force Method for brace connection.  Case when beam shear reaction contribution is reduced by a force  DeltaV_b.
        /// </summary>
        ...
        [MultiReturn(new[] { "V_uc","V_ub","M_ub","H_ub","H_uc" })]
        public static Dictionary<string, object> UFMForcesSpecialCase2(double d_b,double d_c,double theta,double alpha,double alpha_bar,
            double beta,double beta_bar,double P_u,double DeltaV_b,double R_beam,bool IncludeDistortionalMomentForces=false,double M_d=0,double A_ub=0)
        {
            //Default values
            double V_uc = 0;
            double V_ub = 0;
