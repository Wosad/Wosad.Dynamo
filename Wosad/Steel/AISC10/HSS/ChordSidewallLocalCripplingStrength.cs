...
/// <summary>
///     Chord sidewall local crippling strength
...
/// 
    ...
    public partial class Truss 
    {
        ...
        public static Dictionary<string, object> ChordSidewallLocalCripplingStrength(string HssTrussConnectionMemberType, string HssTrussConnectionClassification, CustomProfile MainBranchSection, double theta_main, string ForceTypeMain,
