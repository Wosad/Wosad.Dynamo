...
/// <summary>
///     Chord sidewall local yielding strength
...
/// 
    ...
    public partial class Truss 
    {
        ...
        public static Dictionary<string, object> ChordSidewallLocalYieldingStrength(string HssTrussConnectionMemberType, string HssTrussConnectionClassification, CustomProfile MainBranchSection, double theta_main, string ForceTypeMain,
            CustomProfile SecondaryBranchSection, double theta_sec, string ForceTypeSecondary, double F_yb, CustomProfile ChordSection, double F_yc, bool IsTensionChord, double P_uChord, double M_uChord, double O_v)
        {
            //Default values
            double phiP_nMain = 0;
            double phiP_nSec = 0;
            ...
            phiP_nSec = conSec.GetChordSidewallLocalYieldingStrength().Value;
            phiP_nMain = conMain.GetChordSidewallLocalYieldingStrength().Value;

            IsApplicableMain = conMain.GetChordSidewallLocalYieldingStrength().IsApplicable;
            IsApplicableSecn = conSec.GetChordSidewallLocalYieldingStrength().IsApplicable;
