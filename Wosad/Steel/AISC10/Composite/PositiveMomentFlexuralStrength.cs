...
/// 
    ...
    public partial class Flexure 
    {
        ...
        public static Dictionary<string, object> PositiveMomentFlexuralStrength(CompositeSteelShape Shape, double b_eff, double h_solid, double h_rib, double F_y, double fc_prime, double SumQ_n)
        {
            //Default values
            double phiM_n = 0;
