...
using Dynamo.Nodes;
using steel = Wosad.Steel.AISC;
using Wosad.Steel.AISC.AISC360v10.Composite;
using System;

#endregion

namespace Steel.AISC10.Composite
{
...
/// 
    ...
    public partial class Anchor 
    {
        ...
        public static Dictionary<string, object> HeadedAnchorPositionAndGroupFactors(string HeadedAnchorDeckCondition,string HeadedAnchorWeldCase,double N_saRib,double e_mid_ht,double h_r,double w_r)
        {
            //Default values
            double R_g = 0;
            double R_p = 0;
