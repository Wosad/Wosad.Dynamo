...
/// <summary>
///     Flexural  flange local buckling 
...
/// 
    ...
    public partial class Flexure 
    {
        ...
        public static Dictionary<string, object> FlexuralFlangeLocalBuckling(CustomProfile Shape, double F_y, string BendingAxis="Axis", string FlexuralCompressionLocation="Top", double E = 29000, bool IsRolledMember = true)
        {
            //Default values
            double phiM_n = 0;
            ...
            beam.GetFlexuralFlangeLocalBucklingStrength(FlexuralCompression);
            phiM_n = FLB.Value;

            IsApplicableLimitState = FLB.IsApplicable;
