...
/// <summary>
///     Flexural web or wall local buckling
...
/// 
    ...
    public partial class Flexure 
    {
        ...
        public static Dictionary<string, object> FlexuralWebOrWallLocalBuckling(CustomProfile Shape, double F_y, string BendingAxis="XAxis", string FlexuralCompressionLocation="Top", double E = 29000, bool IsRolledMember = true)
        {
            //Default values
            double phiM_n = 0;
            ...
            beam.GetFlexuralWebOrWallBucklingStrength(FlexuralCompression);
            phiM_n = WLB.Value;

            IsApplicableLimitState = WLB.IsApplicable;
